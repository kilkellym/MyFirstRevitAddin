...
namespace MyFirstRevitAddin
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            ButtonDataClass myButtonData1 = new ButtonDataClass("btnArchSmarter_Addin_Template_2023_1", "Text to\rUPPER", Command1.GetMethod(), Properties.Resources.Blue_32, Properties.Resources.Blue_16, "Changes text notes  to UPPER case");
            ButtonDataClass myButtonData2 = new ButtonDataClass("btnArchSmarter_Addin_Template_2023_2", "Text to\rlower", Command2.GetMethod(), Properties.Resources.Red_32, Properties.Resources.Red_16, "Changes text notes to lower case");
